...
// ─── Article / Blog ───────────────────────────────────
export const articlePageWrapper  = "max-w-4xl mx-auto px-6 py-16"
...
export const articleCategory    = "text-xs font-semibold text-[#0066cc] uppercase tracking-widest mb-2"
export const articleMainTitle   = "text-3xl font-bold text-[#1d1d1f] tracking-tight leading-tight mb-4"
export const articleAuthorRow   = "flex items-center gap-3 mb-6"
export const authorInfo         = "text-sm text-[#6e6e73]"
export const articleContent     = "prose prose-gray max-w-none mb-8"
export const articleFooter      = "text-xs text-[#a1a1a6] border-t border-[#e8e8ed] pt-4 mt-8"
export const articleActions     = "flex gap-3 mb-6"
export const editBtn            = "bg-[#0066cc] text-white font-semibold px-4 py-2 rounded-full hover:bg-[#004499] transition-colors cursor-pointer text-sm"
export const deleteBtn          = "border border-[#d2d2d7] text-[#1d1d1f] font-medium px-4 py-2 rounded-full hover:bg-[#f5f5f7] transition-colors cursor-pointer text-sm"
