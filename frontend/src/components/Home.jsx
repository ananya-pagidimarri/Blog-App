  ...
  return (
    ...
    <div className="min-h-screen bg-gray-50 overflow-hidden">
      ...
      <nav className="sticky top-0 z-50 bg-white/90 backdrop-blur-lg border-b border-gray-200 shadow-sm">
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12 py-4 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="w-11 h-11 rounded-2xl bg-blue-600 flex items-center justify-center text-white font-bold text-xl shadow-lg">
              M
            </div>
      ...
      <section className="max-w-7xl mx-auto px-6 md:px-12 py-20 grid lg:grid-cols-2 gap-16 items-center">
        ...
        <div>
          ...
          <p className="mt-8 text-lg text-gray-600 leading-relaxed max-w-xl">
            ...
            A modern blogging platform where creators,
            developers, and writers can publish stories,
      ...
      <section className="max-w-7xl mx-auto px-6 md:px-12 py-16">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-gray-600 text-lg">
            Everything you need for modern blogging.
          </p>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          ...
          <div className="bg-white rounded-3xl p-8 shadow-md border border-gray-100 hover:shadow-xl transition">
            ...
            <p className="text-gray-600 leading-relaxed">
              Create blogs with formatting and engaging storytelling.
            </p>
      ...
      <section className="max-w-7xl mx-auto px-6 md:px-12 pb-24">
        ...
        <div className="bg-blue-600 rounded-3xl p-12 text-center shadow-2xl">
